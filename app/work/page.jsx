...
const projects = [
  {
    ...
    catagory: 'frontend', 
    title: 'project 1', 
    description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium illum odio earum omnis reiciendis.', 
      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row xl:gap-[30px]'>
          <div className='w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none'>
            <div className='flex flex-col gap-[30px] h-[10%]'>
              {/* outline nums */}
            ...
            <Swiper spaceBetween={30} slidesPerView={1} className='xl:h-[520px] mb-12]' onSlideChange={handleSlideChange}>
              {projects.map((item,index) => {
                return <SwiperSlide key={index} className='w-full'>
                  <div className='h-[460px] relative group flex justify-cenetr items-center bg-pink-50/20'>
                    {/* overlay */}
